...
def main():
    ...
    ap.add_argument("--pattern", type=str, default="Photo{id}_depth_warp_masked.png")
    ...
    ap.add_argument(
        "--out-dir",
        type=Path,
        default=ROOT / "packages/depth_anything_notag_20260813_unity10",
    )
    ap.add_argument(
        "--also-copy-to",
        type=Path,
    ...
    also = args.also_copy_to if args.also_copy_to.is_absolute() else ROOT / args.also_copy_to
