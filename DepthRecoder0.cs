...
using System.IO;
public class DepthRecorder0 : MonoBehaviour
{
    private Camera cam;
    ...
    private void OnEnable()
    {
        ...
        sourceRT.Create();
    	//Start a coroutine to wait for the depth texture
        // Important!!! If no coruotine(the depthTexture maybe read before finishing the rendering, depthTexture == null 
        StartCoroutine(WaitForDepthTexture());
    }
    
    private System.Collections.IEnumerator WaitForDepthTexture()
    {
